...
export const Planner = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-white w-full overflow-hidden" onClick={clearSelection}>
      ...
      {/* FILTER MODAL - NEW DEDICATED WINDOW */}
      <Modal isOpen={showFilters} onClose={() => setShowFilters(false)} title="Filtri Planner" className="max-w-sm">
          <div className="space-y-4">
              ...
              >
                  ...
                  <option value="MODIFIED">Solo con Modifiche Manuali</option>
                  <option value="EXTRA">Solo con Voci Extra</option>
              </Select>
              
              <Select 
                  label="Filtra per Matrice" 
                  value={filterMatrix} 
              ...
              <div className="pt-4 border-t flex justify-between">
                  <Button variant="ghost" onClick={() => { setSearchTerm(''); setFilterStatus('ACTIVE'); setFilterMatrix('ALL'); }}>
                      Reset Filtri
                  </Button>
